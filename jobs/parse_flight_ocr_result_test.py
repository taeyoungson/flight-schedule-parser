...
def test_parse_flight_schedule(mocker: pytest_mock.MockFixture):
    ...
    mock_google_calendar_delete_events = mocker.patch("third_party.calendars.gcal.GoogleCalendar.delete_events")
    mock_google_calendar_get_events = mocker.patch("third_party.calendars.gcal.GoogleCalendar.get_events")
    ...
    assert mock_google_calendar_delete_events.call_count == 1
    assert mock_google_calendar_get_events.call_count == 1
