...
def get_timezone_by_iata_code(iata: str) -> str:
    return _AIRPORTS[iata].get("tz")
...
def get_tz_by_iata_code(iata: str) -> zoneinfo.ZoneInfo:
    return zoneinfo.ZoneInfo(_AIRPORTS[iata]["tz"])
